...
class RestaurantServiceTest {
    ...
    public void setUp()
    {
        ...
        service.addRestaurant("Boston's cafe","Chennai",openingTime,closingTime);
        try {
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        ...
        assertThrows(restaurantNotFoundException.class,()->service.findRestaurantByName("DummyRestaurant"));
    }
    //<<<<<<<<<<<<<<<<<<<<SEARCHING>>>>>>>>>>>>>>>>>>>>>>>>>>
